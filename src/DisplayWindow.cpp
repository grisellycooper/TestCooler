...
{
	assert(!vWindowTitle.empty() && vWindowWidth > 0 && vWindowHeight > 0);
...
//	glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);//ʹ�� Core-profile ����ģʽ
//	glfwWindowHint(GLFW_RESIZABLE, GL_FALSE);

#ifdef _DEBUG
	glfwWindowHint(GLFW_OPENGL_DEBUG_CONTEXT, GL_TRUE); //�������������,���OpenGL���л���,��������ʱ��ע��;
#endif
